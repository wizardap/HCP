...
# Force virtual edges
solver.add_clause([edge_to_var[tuple(sorted([255, 1955]))]])
solver.add_clause([edge_to_var[tuple(sorted([3358, 2609]))]])

# Force contracted edges
...
print(f"Added {len(triangles)} triangle cuts. Starting CEGAR on contracted Comp 0 (2186 vertices)...")
t0 = time.time()
it = 0
while True:
    it += 1
